...
public final class OrderController {
  ...
  public OrderResponse placeOrder(@RequestBody final OrderRequest orderRequest) {
    ...
    try {
      LOG.info("Order placed for Item={} by User={}", orderRequest.getItemId(),
      ...
      LOG.error("Exception occurred in placing order for Item={} by User={}",
          orderRequest.getItemId(),
          orderRequest.getUser().getId(), e);
      return OrderResponse.builder()
          .itemId(orderRequest.getItemId())
