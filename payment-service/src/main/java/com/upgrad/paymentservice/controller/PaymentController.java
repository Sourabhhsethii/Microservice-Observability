...
public final class PaymentController {
  ...
  public PaymentResponse makePayment(@RequestBody final PaymentRequest paymentRequest) {
    try {
      log.info("Processing payment for Amount={} and UserId={}", paymentRequest.getAmount(),
      ...
      log.error("Exception in processing payment for Amount={} and UserId={}",
          paymentRequest.getAmount(), paymentRequest.getUserId(), e);
      return PaymentResponse.builder()
